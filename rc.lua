...
run_once({ "unclutter -root", "clipit", "gxkb", "xautolock -time 15 -locker ~/.config/awesome/lock.sh" })
...
globalkeys = awful.util.table.join(
        ...
        --Lock screen
        awful.key({ altkey }, "F12", function () awful.util.spawn("sh -c '~/.i3/lock.sh'") end),
        --Rofi
        awful.key( { modkey }, "d" , function () awful.util.spawn("rofi -combi-modi window,drun -show combi -modi combi,ssh -opacity 50 -font pt\\ mono\\ 9") end),
...
awful.rules.rules = {
    ...
    { rule = { },
      properties = { border_width = beautiful.border_width,
                     ...
                     placement = awful.placement.centered, --no_overlap+awful.placement.no_offscreen,
    ...
    -- Set Terminal to always map on the first tag on screen 1.
    { rule = { class = "Termite" },
    ...
    -- Set Sublime|Code|Gogland to always map on the second tag on screen 1.
    { rule = { class = "Subl3" },
